		...
		<div class="ui segment">
			...
			<div if={ opts.connection.page } class="ui middle aligned relaxed divided list">
				<div class="item">
					...
					<div class="left floated content" data-key={ key }>
						<div each={ index in [0,1,2,3,4,5,6,7,8] } class="ui circular icon button tooltip current-page-tooltip" style="margin: 0; padding: 0; background-color: transparent; cursor: default;" data-html={findTooltip(index)}>
